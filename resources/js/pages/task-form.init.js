...
function makeid(a) { for (var t = "", e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", s = e.length, d = 0; d < a; d++) t += e.charAt(Math.floor(Math.random() * s)); return t }
$(document).ready(function() {
    "use strict";
    $("#NewtaskForm").validate({ rules: { "member[]": { required: !0 } }, errorPlacement: function(a, t) { t.is(":checkbox") ? a.insertAfter("#taskassignee") : a.insertAfter(t) } }), $(".addtask-btn").click(function() {
    ...
    }), $("select#TaskStatus").change(function() { selectedstatus = $(this).children("option:selected").val() }), $("#addtask").click(function() {
        ...
        var a = makeid(5),
            t = $("#taskname").val(),
            e = new Date,
            s = e.getDate() + " " + e.toLocaleString("default", { month: "short" }) + ", " + e.getFullYear(),
            d = $("#taskdesc").val(),
            e = "";
        0 < d.length && (e = "<ul class='ps-3 mb-4 text-muted' id='task-desc'><li class='py-1'>" + d + "</li></ul>");
        var l, d = $("#taskbudget").val(),
            n = new Array,
            o = new Array,
            r = "";
        for ($("#taskassignee input[type=checkbox]:checked").each(function() { o.push($(this).attr("id")), n.push($(this).nextAll("img").attr("src")) }), i = 0; i < n.length; i++) r = r + '<div class="avatar-group-item"><a href="#" class="d-inline-block" value="' + o[i] + '"><img src="' + n[i] + '" class="rounded-circle avatar-xs" alt=""></a></div>';
