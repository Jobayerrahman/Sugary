        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ route('root') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/assets/images/logo-minimized.png') }}" alt="">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/logo-white@2x.png') }}" alt="">
                    </span>
                </a>
            </div>
            ...
            <button type="button" class="btn btn-sm px-3 font-size-16 header-item waves-effect" id="vertical-menu-btn">
                ...
                <i class="bx bx-poll" style="font-size: 2em;"></i>
            </button>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user d-none d-xl-inline-block" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="#"><i class="bx bx-clipboard font-size-16 align-middle me-1"></i>
                        <span key="t-my-note">@lang('translation.My_Notes')</span></a>
                    <a class="dropdown-item" href="#"><i class="bx bx-link font-size-16 align-middle me-1"></i> <span key="t-submit-links">@lang('translation.Submit_Links')</span></a>
                    <a class="dropdown-item" href="#"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-my-profile">@lang('translation.My_Profile')</span></a>
                    <a class="dropdown-item" href="#"><i class="bx bx-bolt-circle font-size-16 align-middle me-1"></i> <span key="t-shortcuts">@lang('translation.Shortcuts')</span></a>
                    <a class="dropdown-item" href="#"><i class="bx bx-key font-size-16 align-middle me-1"></i> <span key="t-change-password">@lang('translation.Change_Password')</span></a>
                    <a class="dropdown-item" href="#"><i class="bx bx-confused font-size-16 align-middle me-1"></i>
                        <span key="t-issues-advices">@lang('translation.Issues_Advices')</span></a>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon right-bar-toggle waves-effect" data-bsStyle="assets/css/bootstrap-dark.min.css" data-appStyle="assets/css/app-dark.min.css">
