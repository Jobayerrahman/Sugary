...
<div class="row">
    ...
    <div class="col-4">
                ...
                <div class="card">
                    <div class="d-flex justify-content-center p-1">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <span id="renderRange" class="render-range fw-bold mt-2">January</span>
                ...
                <div class="card">
                    <div class="d-flex justify-content-center p-1">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <span id="renderRange" class="render-range fw-bold mt-2">2020</span>
                            <button type="button" class="btn move-day" data-action="move-next">
                                <i class="calendar-icon ic-arrow-line-right mdi mdi-chevron-right" data-action="move-next"></i>
                            </button>
                        </div>
        ...
        <h6 class="text-center text text-black-50">Order Stats</h6>
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="row">
        ...
        <h6 class="text-center text text-black-50">Detail Stats</h6>
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="car-body p-3">
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-between">
                                            ...
                                            <h6 class="text-end text-warning">Collabs <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="car-body p-3">
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-between">
                                            ...
                                            <h6 class="text-end text-danger">Weddings <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="car-body p-3">
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-between">
                                            <h6 class="text-left text-info">04</h6>
                                            <h6 class="text-end text-info">Surprises <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <h6 class="text-center text text-black-50">Geographical Stats</h6>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
