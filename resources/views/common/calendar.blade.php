                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            ...
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Regular Delivery</span>
                                                            <br>
                                                            <p class="badge badge-soft-warning text-soft-warning mt-2 p-2">2:30PM</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="row">
                                                            <div class="col-12 mt-4">
                                                                <div class="text-end mt-3">
                                                                    <span class="badge badge-soft-secondary font-size-11 rounded-circle p-1 mb-2" id="task-status">P</span> <br>
                                                                    <span class="badge badge-soft-secondary font-size-11 p-2" id="task-status">Collection</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            <span class="btn btn-sm btn-primary" style="width: 50px;"></span>
                                                            <span class="btn btn-sm btn-info" style="width: 50px;"></span>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Rajia Islam</a></h5>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Dhaka</span>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Regular Delivery</span>
                                                            <br>
                                                            <p class="badge badge-soft-warning text-soft-warning mt-2 p-2">4:00PM</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="row">
                                                            <div class="col-12 mt-4">
                                                                <div class="text-end mt-3">
                                                                    <span class="badge badge-soft-secondary font-size-11 rounded-circle p-1 mb-2" id="task-status">R</span> <br>
                                                                    <span class="badge badge-soft-secondary font-size-11 p-2" id="task-status">Crafting</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            <span class="btn btn-sm btn-primary" style="width: 50px;"></span>
                                                            <span class="btn btn-sm btn-info" style="width: 50px;"></span>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Tasaddek Mushfiq</a></h5>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Dhaka</span>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Special Delivery</span>
                                                            <br>
                                                            <p class="badge badge-soft-warning text-soft-warning mt-2 p-2">8:30PM</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <div class="row">
                                                            <div class="col-12 mt-4">
                                                                <div class="text-end mt-3">
                                                                    <span class="badge badge-soft-secondary font-size-11 rounded-circle p-1 mb-2" id="task-status">L</span> <br>
                                                                    <span class="badge badge-soft-secondary font-size-11 p-2" id="task-status">Ready</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            <span class="btn btn-sm btn-primary" style="width: 50px;"></span>
                                                            <span class="btn btn-sm btn-info" style="width: 50px;"></span>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Rashik Rahman</a></h5>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Dhaka</span>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Regular Delivery</span>
                                                            <br>
                                                            <p class="badge badge-soft-warning text-soft-warning mt-2 p-2">4:00PM</p>
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            <span class="btn btn-sm btn-primary" style="width: 50px;"></span>
                                                            <span class="btn btn-sm btn-info" style="width: 50px;"></span>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Rubina Zaman</a></h5>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Dhaka</span>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Special Delivery</span>
                                                            <br>
                                                            <p class="badge badge-soft-warning text-soft-warning mt-2 p-2">8:30PM</p>
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            <span class="btn btn-sm btn-primary" style="width: 50px;"></span>
                                                            <span class="btn btn-sm btn-info" style="width: 50px;"></span>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Tanvir Alam</a></h5>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Dhaka</span>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Special Delivery</span>
                                                            <br>
                                                            <p class="badge badge-soft-warning text-soft-warning mt-2 p-2">8:30PM</p>
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            <span class="btn btn-sm btn-primary" style="width: 50px;"></span>
                                                            <span class="btn btn-sm btn-info" style="width: 50px;"></span>
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Samiha Sultana</a></h5>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Dhaka</span>
                                                            <span class="badge badge-soft-secondary font-size-11" id="task-status">Special Delivery</span>
                                                            <br>
                                                            <p class="badge badge-soft-warning text-soft-warning mt-2 p-2">4:00PM</p>
                        ...
                        <div class="card mb-1">
                            <div class="car-body p-1" style="border-radius: 2px; background-color: #eaf5ea;">
                                <div class=" d-flex justify-content-between me-1">
                                    ...
                                    <h6 class="text-end text-success font-size-12 me-1">Delivered <i class="bx bxs-circle text-success font-size-11"></i></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-1">
                            <div class="car-body p-1" style="border-radius: 2px; background-color: #eaeff5;">
                                <div class=" d-flex justify-content-between ml-1">
                                    ...
                                    <h6 class="text-end text-primary font-size-12 me-1">International <i class="bx bxs-circle text-primary font-size-11"></i></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-1">
                            <div class="car-body p-1" style="border-radius: 2px; background-color: #f5eaec;">
                                <div class=" d-flex justify-content-between ml-1">
                                    ...
                                    <h6 class="text-end text-danger font-size-12 me-1">Cancelled <i class="bx bxs-circle text-danger font-size-11"></i></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-1">
                            <div class="car-body p-1" style="border-radius: 2px; background-color: #f5eaf3;">
                                <div class=" d-flex justify-content-between ml-1">
                                    ...
                                    <h6 class="text-end text-primary font-size-12 me-1">Surprises <i class="bx bxs-circle text-primary font-size-11"></i></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-1">
                            <div class="car-body p-1" style="border-radius: 2px; background-color: #edeaf5;">
                                <div class=" d-flex justify-content-between ml-1">
                                    ...
                                    <h6 class="text-end text-info font-size-12 me-1">Concierge <i class="bx bxs-circle text-info font-size-11"></i></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-1">
                            <div class="car-body p-1" style="border-radius: 2px; background-color: #f5f2ea;">
                                <div class=" d-flex justify-content-between ml-1">
                                    ...
                                    <h6 class="text-end text-warning font-size-12 me-1">Pending <i class="bx bxs-circle text-warning font-size-11"></i></h6>
                                </div>
                            </div>
                        </div>
                    </div>
