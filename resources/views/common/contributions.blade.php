                                    ...
                                    <div>
                                        <ul class="nav nav-pills justify-content-end">
                                            <li class="nav-item mx-1">
                                                <a class="btn btn-sm p-2 buttom-box buttom-box-success" href="#" tabindex="-1" aria-disabled="true">
                            ...
                            <table class="table table-nowrap t-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>10384 BDT</td>
                                        <td>
                                            <span class="badge badge-pill badge-soft-success font-size-11">Select</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>10384 BDT</td>
                                        <td>
                                            <span class="badge badge-pill badge-soft-success font-size-11">Seleted</span>
                                        </td>
                                        <td class="table-right-redius">12-sep-21 5:30pm</td>
                                    </tr>
                                </tbody>
        ...
        <div class="row">
                ...
                <div class="card card-container">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>Super pleased with the execution of ervery order I have trusted them with. I highly recommend them for their superb service that cates to erery demand!</p>
                            </div>
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between">
                    <a href="#" class="btn btn-sm p-3 buttom-status-md button-status-success">
                        <i class="bx bxs-user-check"></i>
                        <span class="pt-1">Select This</span>
                    </a>
                    <a href="#" class="btn btn-sm p-3 buttom-status-md button-status-danger">
