        ...
        <div class="task_card_area">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>New Tasks</h4>
                    <div id="task-1">
                        <div id="new-tasks" class="pb-1 task-list">
                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            <div>
                                                ...
                                                <br>
                                                <p class="badge badge-soft-danger text-soft-warning mt-2 p-2">14 Oct,
                                                    2019</p>
                                            </div>
                                        </div>
                                        <div class="col-5">
        ...
        <div class="task_card_area">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>In Process</h4>
                    <div id="task-1">
                        <div id="in-process" class="pb-1 task-list">
        ...
        <div class="task_card_area">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Finalisation</h4>
                    <div id="task-1">
                        <div id="finalisation" class="pb-1 task-list">
        ...
        <div class="task_card_area">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <div id="task-1">
                        <div id="done-tasks" class="pb-1 task-list">
