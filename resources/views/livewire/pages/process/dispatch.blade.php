        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>On Delivery</h4>

                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="on-delivery" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="on-delivery">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Revise & Issues</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="revise-issues" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="revise-issues">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Payments Verify</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="payments-verify" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="payments-verify">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Review</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="review" class="pb-1 task-list">
                                ...
                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="review">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
