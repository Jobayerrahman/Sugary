                ...
                <div class="card-body">
                    ...
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="new-concierge" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="new-concierge">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Collection</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="collection" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="collection">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Design</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="design" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="design">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Printing</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="printing" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="printing">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Crafting</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="crafting" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="crafting">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Pictures</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="pictures" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="pictures">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
                                ...
                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="upictures">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
