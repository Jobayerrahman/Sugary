                ...
                <div class="card-body">
                    ...
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="new-crafting" class="pb-1 task-list">


                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="new-crafting">
                    ...
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="inform-cancellation" class="pb-1 task-list">
                                ...
                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="inform-cancellation">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
