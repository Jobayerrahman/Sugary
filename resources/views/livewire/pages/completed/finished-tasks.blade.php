                        ...
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="finished-tasks-new" class="pb-1 task-list">
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div>
                                                            ...
                                                            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark" id="task-name">Tahnia Safa</a>
                                                            </h5>
                ...
                <div class="task_card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="finished-tasks-inform-call" class="pb-1 task-list">
                ...
                <div class="task_card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="finished-tasks-call-priorities" class="pb-1 task-list">
    ...
    <div class="col-4">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="d-flex justify-content-center p-1">
                        <div id="carouselMonthCaption" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="#carouselMonthCaption" type="button" class="btn move-day" data-bs-slide="prev">
                                ...
                                <a href="#carouselMonthCaption" type="button" class="btn move-day" data-bs-slide="next">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="d-flex justify-content-center p-1">
                        <div id="carouselYearCaption" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="#carouselYearCaption" type="button" class="btn move-day" data-bs-slide="prev">
                                    <i class="calendar-icon ic-arrow-line-left mdi mdi-chevron-left"></i></a>
                                </a>
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active mt-2">
                                ...
                                <a href="#carouselYearCaption" type="button" class="btn move-day" data-bs-slide="next">
                                    <i class="calendar-icon ic-arrow-line-right mdi mdi-chevron-right"></i>
                                </a>
                            </div>
                        </div>
        ...
        <h6 class="text-center text">Order Stats</h6>
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="car-body p-3">
                                    <div class="row">
                                        <div class="col-6">
                                            <span class="text-left">127</span>
                                        </div>
                                        <div class="col-6">
                                            <h6 class="text-end">Delivered <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="car-body p-3">
                                    <div class="row">
                                        <div class="col-6">
                                            <span class="text-left">88</span>
                                        </div>
                                        <div class="col-6">
                                            <h6 class="text-end">Cancelled <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="car-body p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <h6 class="text-end">Deleted <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="car-body p-3">
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-between">
                                            ...
                                            <h6 class="text-end text-primary">Personalize <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="car-body p-3">
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-between">
                                            ...
                                            <h6 class="text-end text-soft-success">Business <i class="bx bxs-circle"></i></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
