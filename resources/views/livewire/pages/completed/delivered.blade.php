                        ...
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="delivered-new" class="pb-1 task-list">
                ...
                <div class="task_card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="delivered-inform-call" class="pb-1 task-list">
                ...
                <div class="task_card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="delivered-call-priorities" class="pb-1 task-list">
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h6 class="text-center text-success font-size-14 mt-2"> <i class="bx bxs-circle"></i>
                            </h6>
                        </div>
                        <div class="col-12">
                            <h1 class="text-center text-success mt-4">127</h1>
                        </div>
                        <div class="col-12">
                            <h6 class="text-center text-success font-size-12 mt-4">Delivered</h6>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="car-body p-3">
                                    <div class=" d-flex justify-content-between ml-1">
                                        ...
                                        <h6 class="text-end text-primary">Personalize <i class="bx bxs-circle text-primary"></i></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="car-body p-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <h6 class="text-end text-info">Delivery <i class="bx bxs-circle"></i></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
