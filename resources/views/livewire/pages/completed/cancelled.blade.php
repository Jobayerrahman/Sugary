                        ...
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="cancelled-new" class="pb-1 task-list">
                ...
                <div class="task_card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="cancelled-inform-call" class="pb-1 task-list">
                ...
                <div class="task_card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="task-1">
                                <div class="task_card_area">
                                    <div id="cancelled-call-priorities" class="pb-1 task-list">
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h6 class="text-center text-danger font-size-14 mt-2"> <i class="bx bxs-circle"></i></h6>
                        </div>
                        <div class="col-12">
                            <h1 class="text-center text-danger mt-4">88</h1>
                        </div>
                        <div class="col-12">
                            <h6 class="text-center text-danger font-size-12 mt-4">Cancelled</h6>
                        </div>
                    </div>
                </div>
            </div>
