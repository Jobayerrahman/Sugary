        ...
        <div class="card">
            <div class="card-body d-flex justify-content-between">
                <div class="d-sm-flex flex-wrap gap-1">
                    ...
                    <div class="">
                        <button type="button" class="btn btn-light move-today" data-action="move-today">Return to
                            Today</button>
                    </div>
                ...
                <div>
                    ...
                    <div class="btn-group">
                        <button class="btn btn-outline-secondary dropdown-toggle btn-md mb-2" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-outline-secondary btn-md mb-2"><i class="bx bx-edit"></i>Bulk
                            Edit</button>
                    </div>
                    <div class="btn-group">
                        <label class="btn btn-outline-secondary"> <i
                                class="mdi mdi-dots-vertical m-0 text-muted h5"></i></label>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form action="">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="mt-4">
                                <a type="submit" class="btn btn-dark waves-effect btn-label waves-light"> <i
                                        class="bx bx-check-double label-icon "></i>Add</a>
                            </div>
                        </div>
                    </form>
                </div>
