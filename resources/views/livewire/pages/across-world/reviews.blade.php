                    ...
                    <div class="card-body">
                                    ...
                                    <div>
                                        <ul class="nav nav-pills justify-content-end">
                                            <li class="nav-item mx-2">
                                                <a class="btn btn-sm p-2 buttom-box buttom-box-primary active"
                                                    href="#file-type" tabindex="-1" aria-disabled="true" data-bs-toggle="tab" role="tab">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="file-type" role="tabpanel">
                                ...
                                <div class="table-responsive mt-2 table_area" id=""
                                    ...
                                    <table class="table table-nowrap t-hover mb-0">
                                        ...
                                        <tbody class="table_body">
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-pill badge-soft-success font-size-11">Approved</span>
                                                </td>
                            ...
                            <div class="tab-pane" id="rejected" role="tabpanel">
                                ...
                                <div class="table-responsive mt-2 table_area"
                                    style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <table class="table table-nowrap t-hover mb-0">
                                        <thead class="table-light">
                                            <tr>
    ...
    <div class="col-4">
        <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <ul class="nav nav-pills justify-content-end">
                                                <li class="nav-item">
                                                    <a href="#carouselExampleCaption" type="button"
                                                        class="btn move-day p-0" data-bs-slide="prev">
                                                        <i class="bx bxs-caret-left-circle font-size-22"></i>
                                                    </a>
                                                    <a href="#carouselExampleCaption" type="button"
                                                        class="btn move-day p-0" data-bs-slide="next">
                                                        <i class="bx bxs-caret-right-circle font-size-22"></i>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-12 text-center">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <h5>Sugary is the best gift curating service out here in Dhaka! 1</h5>
                                            <br />
                                            <br />
                                            <h5>Super pleased with the execution of ervery order I have trusted them
                                                with. I
                                                highly recommend them for their superb service that cates to erery
                                                demand!
                                            </h5>
                                        </div>
                                        <div class="carousel-item">
                                            <h5>Sugary is the best gift curating service out here in Dhaka! 2</h5>
                                            <br />
                                            <br />
                                            <h5>Super pleased with the execution of ervery order I have trusted them
                                                with. I
                                        ...
                                        <div class="carousel-item">
                                            <h5>Sugary is the best gift curating service out here in Dhaka! 3</h5>
                                            <br />
                                            <br />
                                            <h5>Super pleased with the execution of ervery order I have trusted them
                                                with. I
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-5 p-0">
                        <a href="#" class="btn btn-sm p-2 ms-1 buttom-status-md btn_success button-status-success">
                    ...
                    <div class="col-3 p-0">
                        <a href="#" class="btn btn-sm p-2 ms-1 buttom-status-md btn_danger button-status-danger">
                            <div class="d-flex justify-content-between">
                    ...
                    <div class="col-2 p-0">
                        <a href="#" class="btn btn-sm ms-1 p-1 buttom-status-sm">
                        ...
                        <table class="table mb-0">
                            <tbody class="p-3">
                                ...
                                <tr>
                                    ...
                                    <td>Super pleased with the execution of ervery order I have trusted them with. I
                                        highly recommend them for their superb service that cates to erery demand!</td>
                                </tr>
                                <tr>
