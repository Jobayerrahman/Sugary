            ...
            <div class="card me-2">
                <div class="card-body">
                    <div class="dropdown float-end">
                        <a href="#"><i class="bx bxs-comment-adds"></i></a>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#">NOtify When</a>
                        </div>
                    </div> <!-- end dropdown -->

                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Business</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="business" class="pb-1 task-list">
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
                                                    ...
                                                    <span class="badge task-badge font-size-11" id="task-status">Dhaka</span>
                                                    <span class="badge task-badge font-size-11" id="task-status">2pm - 4pm</span>
                                                    <br>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Collabs</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="collabs" class="pb-1 task-list">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Surprises</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="surprises" class="pb-1 task-list">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Weddings</h4>
                    <div id="task-1" >
                        <div class="task_card_area">
                            <div id="weddings" class="pb-1 task-list">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Investigate</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="investigate" class="pb-1 task-list">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Quotation & Confirmation</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="quotation-confirmation" class="pb-1 task-list">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Inform Cancellation</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="inform-cancellation" class="pb-1 task-list">
