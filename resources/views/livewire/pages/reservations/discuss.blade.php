                ...
                <div class="card-body">
                    ...
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="new-call" class="pb-1 task-list">
                                <div class="card task-box task_box_items">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="inform-call" class="pb-1 task-list">
                                <!-- Card start -->
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <div id="task-3">
                        <div class="task_card_area">
                            <div id="call-priorities" class="pb-1 task-list">
                                <!-- Card start -->
                                <div class="card task-box task_box_items" id="uptask-1">
                                    <div class="card-body p-3">
                                        <div class="row">
                    ...
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="investigate" class="pb-1 task-list">
                                <!-- Card start -->
                                <div class="card task-box task_box_items shadow" id="uptask-1">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            <div class="col-7">
                                                <div>
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4"><i class="bx bx-list-plus"></i>Update & Pay</h4>
                    <div id="task-1">
                        <div class="task_card_area">
                            <div id="update-pay" class="pb-1 task-list">
                                <!-- Card start -->
                                <div class="card task-box task_box_items shadow" id="uptask-1">
                                    <div class="card-body p-3">
                                        <div class="row">
        ...
        <div class="task_card">
            <div class="card me-2">
                <div class="card-body">
                    ...
                    <div id="task-1" class="task_card_area">
                        <div class="task_card_area">
