            ...
            <div class="new-product mt-3">
                <a href="{{ route('products.create') }}">
                    <div class="d-flex justify-content-between">
                        ...
                        <span><strong>New Product</strong></span>
                    </div>
                </a>
            </div>
            <div class="btn-save">
                        ...
                        <div class="col-4">
                            <div class="add-product-form p-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" wire:model.defer="state.title" placeholder="FP9237 Gifting - Femme" class="form-control @error('title') is-invalid @enderror" id="title">
                                    @error('title')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea placeholder="FP9237 Gifting - Femme" class="form-control @error('description') is-invalid @enderror" wire:model.defer="state.description" id="description" rows="3"></textarea>
                                    @error('description')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                {{-- <div class="form-group">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <label class="form-label onclick"
                                            onclick="Livewire.emit('openModal', 'modals.category-create-modal')">Add
                                            New</label>
                                    </div>
                                    <div class="mb-3">
                                        <select wire:model.defer="state.category_id" multiple
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-between">
                                        <label class="form-label">Category</label>
                                        <label class="form-label onclick" onclick="Livewire.emit('openModal', 'modals.category-create-modal')">Add New</label>
                                    </div>
                                    <x-select2 wire:model.defer="state.category_ids" placeholder="Select Category" id="category_ids">
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}">
                                                {{ $category->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <label class="form-label onclick"
                                            onclick="Livewire.emit('openModal', 'modals.reason-season-create-modal')">Add
                                            New</label>
                                    </div>
                                    {{-- <div class="mb-3">
                                        <select id="subcategoryList" wire:model.defer="state.reason_season_ids"
                                            class="form-control @error('reason_season_ids') is-invalid @enderror">
                                            <option selected disabled>Select Reason Seasons</option>
                                            @foreach ($reasonSeasons as $reasonSeason)
                                                <option value="{{ $reasonSeason->id }}">
                                                    {{ $reasonSeason->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('reason_season_ids')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div> --}}
                                    <x-select2 wire:model.defer="state.reason_season_ids" placeholder="Select Reason & Season" id="reason_season_ids">
                                        @foreach ($reasonSeasons as $reasonSeason)
                                            <option value="{{ $reasonSeason->id }}">
                                                {{ $reasonSeason->name }}
                                            </option>
                                ...
                                <div class="form-group">
                                    <div class="mb-0">
                                        ...
                                        {{-- <div class="mb-3">
                                            <select wire:model.defer="state.tag_id" class="form-control  @error('tag_id') is-invalid @enderror">
                                        ...
                                        <x-select2 wire:model.defer="state.tag_ids" placeholder="Select Tags" id="tag_ids">
                                            @foreach ($tags as $tag)
                                                <option value="{{ $tag->id }}">
                                                    {{ $tag->name }}</option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <input type="text" wire:model.defer="state.custom_text_label" class="form-control" placeholder="Type Here">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <input type="text" wire:model.defer="state.custom_file_label" class="form-control" placeholder="Type Here">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="mb-2 border p-2 rounded black-check-btn">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.defer="state.is_buniness_gifting" type="checkbox" name="mark_as_business_gifting"
                                    ...
                                    <div class="mb-2 border p-2 rounded black-check-btn">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.defer="state.is_mark_as_drip" type="checkbox" name="mark_as_drip"
                                                id="mark_as_drip">
                                    ...
                                    <div class="mb-2 border p-2 rounded black-check-btn">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.defer="state.is_caution_of_availability" type="checkbox" name="flexRadioDefault"
                                                id="caution_of_availablility">
                                    ...
                                    <div class="col-9">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <input type="text" wire:model.defer="state.base_specs_old_cost" class="form-control @error('base_specs_old_cost') is-invalid @enderror"
                                                            placeholder="Old Cost">
                                                            @error('base_specs_old_cost')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="mb-3">
                                                        <input type="text" wire:model.defer="state.base_specs_current_cost" class="form-control @error('base_specs_current_cost') is-invalid @enderror"
                                                            placeholder="Current Cost">
                                                            @error('base_specs_current_cost')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                    </div>
                                                </div>
                                                <div class="col-9">
                                                    <div class="mb-3">
                                                        <input type="text" wire:model.defer="state.base_specs_sell_price" class="form-control @error('base_specs_sell_price') is-invalid @enderror"
                                                            placeholder="Sale Price">
                                                            @error('base_specs_sell_price')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                    </div>
                                                </div>
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        <input type="text" wire:model.defer="state.base_specs_quantity" class="form-control @error('base_specs_quantity') is-invalid @enderror"
                                                            placeholder="QTY">
                                                            @error('base_specs_quantity')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <input type="text" wire:model.defer="state.dimensions_height" class="form-control @error('dimensions_height') is-invalid @enderror"
                                                            placeholder="Height">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mb-3">
                                                        <input type="text" wire:model.defer="state.dimensions_width" class="form-control @error('dimensions_width') is-invalid @enderror"
                                                            placeholder="Width">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <input type="text" wire:model.defer="state.dimensions_depth" class="form-control @error('dimensions_depth') is-invalid @enderror"
                                                            placeholder="Depth">
                                                            @error('dimensions_depth')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                {{-- <div class="mb-3">
                                                    <select wire:model.defer="state.color_id"
                                ...
                                <div class="row">
                                    <div class="col-9">
                                        <div class="form-group">
                                            ...
                                            {{-- <div class="mb-3">
                                                <select wire:model.defer="state.inventory_placement_id"
                                                    class="form-control @error('inventory_placement_id') is-invalid @enderror">
                                                    <option selected disabled>--Select--</option>

                                                </select>
                                                @error('inventory_placement_id')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div> --}}
                                        ...
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                {{-- <div class="mb-3">
                                                    <select wire:model.defer="state.visible_tag_id"
                                                        class="form-control @error('visible_tag_id') is-invalid @enderror">
                                                        @foreach ($visibleTags as $visibleTag)
                                                            <option value="{{ $visibleTag->id }}">{{ $visibleTag->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('visible_tag_id')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div> --}}
