...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-3">
                <a href="{{ route('products.create') }}" class="text-black-50 ">
            ...
            <div class="col-2">
                <div class="d-flex justify-content-between">
                    <h6 class="mt-2">{{ $products->count() }} items</h6>
                    ...
                    <div class="card-body rounded">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-4">
                                    <div class="mt-4 pt-3">
                                        <h5 class="font-size-14 mb-3">Dimension (MM)</h5>
                                        <input type="text" id="dimensionrange">
                                    </div>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div class="material-img-container">
                                        <div class="position-relative">
                                            <div class="avatar-xs product-ribbon">
                                                <button type="button" onclick="confirmDelete('deleteProduct', {{$product->id}})" class="avatar-title rounded-circle mt-1 bg-danger"><i class="fas fa-trash-alt"></i></button>
                                                <button type="button" class="avatar-title rounded-circle mt-1 bg-warning"><i class="fas fa-edit"></i></button>
                                                <button type="button" onclick="Livewire.emit('openModal', 'modals.product-view-modal', {{ json_encode(['product' => $product->id]) }})" class="avatar-title rounded-circle mt-1 bg-primary"><i class="far fa-eye"></i></button>
                                            </div>
                                ...
                                @else
                                    <div class="material-img-container">
                                        <div class="position-relative">
                                            ...
                                            <img src="assets/images/default.jpg" alt="{{ $product->title }}"
                                                class="img-fluid">
                                        </div>
                                    </div>
                                @endif
                                            ...
                                            <div class="col-8">
                                                <div>
                                                    <h5 class="font-size-16"><a href="javascript: void(0);"
                                                            class="text-dark"
                                                            id="task-name">{{ $product->title }}</a>
                                                    </h5>
                                                    <h6 class="font-size-12">{{ $product->title }}<h6>
                                                            <br>
                                                            <div class="d-flex flex-wrap gap-2">
                                                                @foreach ($product->tags as $tag)
                                                                    <button type="button"
                                                                        class="btn btn-light btn-sm btn-material-cat">{{ $tag->name }}</button>
                                                                @endforeach
                                                            </div>
                                                </div>
                                            </div>
