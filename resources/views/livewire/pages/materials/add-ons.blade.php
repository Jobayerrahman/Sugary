...
<div class="row">
    <div class="col-12">
        <div class="row">
            <div class="col-3">
                <a href="{{ route('addons.create') }}" class="text-black-50">
            ...
            <div class="col-2">
                <div class="d-flex justify-content-between">
                    <h6 class=" mt-2">{{ $addons->count() }} items</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="material-item mb-4">
                            @if ($addon->images->first())
                            <div class="material-img-container">
                                <div class="position-relative">
                                    <div class="avatar-xs product-ribbon">
                                        <button type="button" onclick="confirmDelete('deleteAddon', {{$addon->id}})" class="avatar-title rounded-circle mt-1 bg-danger"><i class="fas fa-trash-alt"></i></button>
                                    ...
                                    <img src="{{ $addon->images->first()->url }}" alt="{{ $addon->title }}" class="img-fluid">
                                </div>
                            </div>
                            @else
                            <div class="material-img-container">
                                <div class="position-relative">
                                    ...
                                    <img src="assets/images/small/img-6.jpg" alt="{{ $addon->title }}" class="img-fluid">
                                </div>
                            </div>
                            @endif
                            <!-- Addon start -->
                            <div class="card material-content p-1 mb-0">
                                <div class="p-2">
                                    <div class="row">
                                        <div class="col-8">
                                            <div>
                                                <h5 class="font-size-16"><a href="javascript: void(0);" class="text-dark" id="task-name">{{ $addon->title }}</a>
                                                </h5>
                                                <h6 class="font-size-12">{{ $addon->description }}</h6>
                                                <br>
                                                <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <div class="col-8">
                                            <div>
                                                ...
                                                <div class="d-flex flex-wrap gap-2">
                                                    ...
                                                    <button type="button" class="btn btn-light btn-sm btn-material-cat">{{ $tag->name }}</button>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
