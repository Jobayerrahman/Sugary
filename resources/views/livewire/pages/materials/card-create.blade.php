            ...
            <div class="new-product mt-3">
                <a href="{{ route('cards.index') }}">
                    <div class="d-flex justify-content-between">
                        ...
                        <span><strong>New Card</strong></span>
                    </div>
                </a>
            </div>
            <div class="btn-save">
                        ...
                        <div class="col-4">
                            <div class="add-product-form p-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" wire:model.defer="state.title" class="form-control @error('title') is-invalid @enderror" id="" placeholder="FP9237 Gifting - Femme">
                                    @error('title')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" wire:model.defer="state.description" id="exampleFormControlTextarea1" rows="3" placeholder="FP9237 Gifting - Femme"></textarea>
                                    @error('description')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <label class="form-label onclick" onclick="Livewire.emit('openModal', 'modals.reason-season-create-modal')">Add
                                            New</label>
                                    </div>
                                    <div class="mb-3">
                                        <select id="subcategoryList" wire:model.defer="state.reason_season_id" class="form-control @error('reason_season_id') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <label class="form-label onclick" onclick="Livewire.emit('openModal', 'modals.tag-create-modal')">Add New</label>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-2 border p-2 rounded black-check-btn">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="custom_text" id="custom_text">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3 border p-2 rounded black-check-btn">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="custom_file" id="custom_file">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-2 border p-2 rounded black-check-btn">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.defer="state.is_buniness_gifting" type="checkbox" name="mark_as_business_gifting" id="mark_as_business_gifting">
                                    ...
                                    <div class="mb-2 border p-2 rounded black-check-btn">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.defer="state.is_caution_of_availability" type="checkbox" name="flexRadioDefault" id="caution_of_availablility">
