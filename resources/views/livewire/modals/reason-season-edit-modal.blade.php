<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Reason & Season</h5>
    ...
    <div class="modal-body">
        <form>
            ...
            <div class="mb-2">
                ...
                <select wire:model.defer="state.category_id" name="category" class="form-control @error('name') is-invalid @enderror">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-light"  wire:click="$emit('closeModal')">Close</button>
